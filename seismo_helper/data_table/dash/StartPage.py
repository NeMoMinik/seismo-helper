...
app.layout = html.Div([
    ...
    html.Div(dbc.NavItem(dbc.NavLink("Мониторинг", href=BASE_LINK + 'Events/', target='_blank',
                                     style={'color': '#000000', 'lineHeight': '50px', 'borderStyle': 'inset',
                                            'margin-top': '15px', 'borderWidth': '5px', 'font-size': '28px'}),
                         style={'background': '#FFFFFF'}),
             style={'width': '40%', 'position': 'absolute', 'right': '30%', 'textAlign': 'center', 'height': '40px'}),
