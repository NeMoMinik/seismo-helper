...
app.layout = html.Div([
    ...
    html.Ul(id='my-list', children=[html.Li('Зарегистрироваться'),
                                    html.Li(
                                        'На странице Events нужно загрузить miniseed-файлы, подождать пока сервер обработает их'),
                                    ImgT1,
                                    html.Li(
                                        'На карте и в таблице под картой будут отображены обнаруженные точки сейсмической активности'),
                                    html.Li(
                                        'Под картой также находятся графики зависимости магнитуды событий от времени и количества событий от магнитуды, красной линией на втором графики обозначен тренд основанный на линейной регрессии.'),
                                    ImgT2
                                    ]),
    footer
])
