...
app.layout = html.Div([
    ...
    dbc.Row([
        dbc.Col([html.Div(images[0]), html.H3("Мастов Арсений"), html.P("Fullstack Developer")], style={'text-align': 'center'}),
        dbc.Col([html.Div(images[1]), html.H3("Старченко Александр"), html.P("ML, DS Engineer")], style={'text-align': 'center'}),
        dbc.Col([html.Div(images[2]), html.H3("Ольга Демидович"), html.P("DS Engineer, UX Designer")], style={'text-align': 'center'}),
        dbc.Col([html.Div(images[3]), html.H3("Борисенко Владислав"), html.P("Frontend Developer + UI & UX Designer")], style={'text-align': 'center'}),
    ...
    dbc.Row([
        dbc.Col([html.Div(images[5],style={'height': '300px', 'width': '300px', 'margin-left':'auto', 'margin-right':'auto'}), html.H2("Матвеев Алексей")], style={'text-align': 'center'}),
        dbc.Col([html.Div(images[6],style={'height': '300px', 'width': '300px', 'margin-left':'auto', 'margin-right':'auto'}), html.H2("Бекренёв Руслан")], style={'text-align': 'center'}),
    ]),
    footer
])